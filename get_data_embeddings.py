...
def get_openai_embeddings(input_filepath, output_filepath):
   ...
   embeddings_df = embeddings_df.head(500)
   #tokenizing
...
get_openai_embeddings("../../nobu-data/s23-thesis-paper/0_lkernel_params_mutable.csv", "../../nobu-data/s23-thesis-paper/test1k_0_lkf_param_embeddings.csv")